...
@section('title', isset($laptop) ? (request()->routeIs('admin.laptops.show') ? 'Detail Alat' : 'Edit Alat') : 'Tambah Alat Baru')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0">
                        <i class="{{ isset($laptop) ? (request()->routeIs('admin.laptops.show') ? 'fas fa-tools' : 'fas fa-edit text-primary') : 'fas fa-plus text-primary' }} me-2"></i>
                        @if(isset($laptop) && request()->routeIs('admin.laptops.show'))
                            Detail Alat: {{ $laptop->merk }} {{ $laptop->model }}
                        @elseif(isset($laptop))
                            Edit Alat: {{ $laptop->merk }} {{ $laptop->model }}
                        @else
                            Tambah Alat Baru
                        @endif
                    </h5>
                    ...
                    @if($mode == 'show')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 text-center mb-4">
                                @if(!empty($laptop->gambar) && file_exists(public_path($laptop->gambar)))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-control-plaintext bg-light p-2 rounded">
                                        @if(isset($laptop->category) && $laptop->category)
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-control-plaintext bg-light p-2 rounded">
                                        ...
                                        @endphp
                                        <span class="badge bg-{{ $statusBadge[$laptop->status] ?? 'secondary' }}">
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            ...
                            <div>
                                ...
                                <form id="delete-form-{{ $laptop->id }}" action="{{ route('admin.laptops.destroy', $laptop->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
                                    ...
                                    <div class="card border-0 bg-light">
                                        <div class="card-body text-center">
                                            ...
                                            <div id="currentPhoto" class="mb-3">
                                                @if($mode == 'edit' && !empty($laptop->gambar) && file_exists(public_path($laptop->gambar)))
                                                    <img src="{{ asset($laptop->gambar) }}" 
